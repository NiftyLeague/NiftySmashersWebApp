        ...
        <div style={{ position: 'relative' }}>
          <AnimatedWrapper>
            <p className="text-align-center animated-header-text animated-header-text-start transition-delay-medium">
              There are 7 tribes to choose from, each with their own unique
              special ability. Some characters specialize in melee combat, while
              others are skilled in ranged attacks or magic.
            </p>
          </AnimatedWrapper>
        </div>
      </div>
      ...
      <div className={styles.section}>
        <AnimatedWrapper>
          ...
          <div className={styles.table}>
            ...
            {NIFTY_DEGENS.map(
              ({ name, description, specialName, gif, image }) => (
                <Grid
                  container
                  spacing={0}
                  key={name}
